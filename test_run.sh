/data/bnf/sw/nextflow/nextflow run main.nf \
			       ...
			       --read1 /data/bnf/dev/bjorn/nextflow_test/supersmall_R1_001.fastq.gz \
			       --read2 /data/bnf/dev/bjorn/nextflow_test/supersmall_R2_001.fastq.gz \
			       --name TEST \
			       ...
			       -with-singularity container_2019-02-22.sif \
